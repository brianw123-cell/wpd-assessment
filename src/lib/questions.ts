...
export const QUESTIONS: Question[] = [
  // Dimension A — Data foundation
  {
    ...
    dimension: 'A',
    type: 'choice',
    prompt: 'If I asked you right now for a list of every job you closed last month with the final dollar amount, how long would that take?',
    options: [
  ...
  },
  {
    ...
    dimension: 'A',
    type: 'choice',
    prompt: 'When a job goes sideways, can you reconstruct what happened from records?',
    options: [
      { score: 3, label: 'Yes, photos, notes and timestamps are all in one place' },
  ...
  // Dimension B — Process
  {
    ...
    dimension: 'B',
    type: 'choice',
    prompt: 'If your best crew lead quit tomorrow, how much of what they do is written down?',
    options: [
  ...
  },
  {
    ...
    dimension: 'B',
    type: 'choice',
    prompt: 'Does a job move through the same steps every time, from lead to final invoice?',
    options: [
      ...
      { score: 0, label: 'Every job is its own thing' },
    ],
  },
  {
    id: 'B3',
  ...
  },
  {
    ...
    dimension: 'C',
    type: 'choice',
    prompt: 'How does information get from the field back to the office?',
    options: [
      { score: 3, label: 'Through an app, automatically' },
      { score: 2, label: 'Photos and texts that someone enters later' },
      { score: 1, label: 'Paperwork that comes in at the end of the week' },
